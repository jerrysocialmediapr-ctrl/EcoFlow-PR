...
function sendEmails_(nombre, email, telefono, pueblo, factura, origen, producto, baseUrl) {
  ...
  if (email && String(email).indexOf("@") !== -1) {
    ...
    } catch (err) { Logger.log("Error email cliente: " + err.message); }
  }
}
...
function addLead_(data) {
  try {
    ...
    if (sendClient) {
      sendEmails_(nombre, email, telefono, pueblo, factura, origen, producto, data.baseUrl);
      var emailIdx = headers.indexOf("Email Enviado");
      if (emailIdx !== -1) sheet.getRange(newRow, emailIdx + 1).setValue("SÍ");
    } else {
      var emailIdx = headers.indexOf("Email Enviado");
...
function buildEcoFlowEmail(nombre, productKey, baseUrl) {
  var base = (baseUrl || "https://jerry.ecoflow-pr.com").replace(/\/+$/, "");
  var products = {
    "Delta Pro 3": { name: "Delta Pro 3", showBundle: true, img: base + "/Delta%20Pro%203/DeltaPro3-frente.png", desc: "4kWh de capacidad. Carga ultra-rápida. App integrada.", bundleTitle: "Delta Pro 3 + Paneles Solares", panels: "4x Panel Rigido 100W", panelImg: base + "/Assets/solar-panel.png", panelDesc: "4 paneles de alta eficiencia para carga solar directa.", badge: "RESPALDO COMPLETO" },
    "Delta 2 Max": { name: "Delta 2 Max", showBundle: true, img: base + "/Delta%202%20max/delta2-frente.png", desc: "2kWh de capacidad. Ideal para apartamentos y backup movil.", bundleTitle: "Delta 2 Max + Paneles Solares", panels: "2x Panel Rigido 100W", panelImg: base + "/Assets/solar-panel.png", panelDesc: "2 paneles para mantenerte cargado de dia.", badge: "MAXIMA PORTABILIDAD" },
    "Delta Pro Ultra": { name: "Delta Pro Ultra", showBundle: false, img: base + "/Delta%20Pro%20Ultra/DeltaProUltra.png", desc: "El sistema mas potente de EcoFlow. Respaldo para toda la casa.", bundleTitle: "Delta Pro Ultra", panels: "", panelImg: "", panelDesc: "", badge: "POTENCIA INDUSTRIAL" },
    "Delta Pro Ultra + SMHP2": { name: "Delta Pro Ultra", showBundle: true, img: base + "/Delta%20Pro%20Ultra/DeltaProUltra.png", desc: "El sistema mas potente de EcoFlow. Respaldo para toda la casa.", bundleTitle: "Delta Pro Ultra + Smart Home Panel 2", panels: "Smart Home Panel 2", panelImg: base + "/Assets/shp2.png", panelDesc: "Integracion total con el switch de transferencia inteligente.", badge: "POTENCIA INDUSTRIAL" }
  };
  ...
  return '<!DOCTYPE html>' +
    ...
    '<p style="margin:0 0 6px 0;"><img src="' + base + '/Assets/email-icons/fan-line-v2.png" width="32" height="32" style="display:block;margin:0 auto;border:none;width:32px;height:32px;" alt="Abanico"/></p>' +
    ...
    '<td width="2%"></td>' +
    '<td width="23%" align="center" bgcolor="#f4f9f6" style="border-radius:10px;padding:14px 6px;">' +
    '<p style="margin:0 0 6px 0;"><img src="' + base + '/Assets/email-icons/fridge-line-v2.png" width="32" height="32" style="display:block;margin:0 auto;border:none;width:32px;height:32px;" alt="Nevera"/></p>' +
    ...
    '<td width="2%"></td>' +
    '<td width="23%" align="center" bgcolor="#f4f9f6" style="border-radius:10px;padding:14px 6px;">' +
    '<p style="margin:0 0 6px 0;"><img src="' + base + '/Assets/email-icons/television-line-v2.png" width="32" height="32" style="display:block;margin:0 auto;border:none;width:32px;height:32px;" alt="Televisor"/></p>' +
    ...
    '<td width="2%"></td>' +
    '<td width="23%" align="center" bgcolor="#f4f9f6" style="border-radius:10px;padding:14px 6px;">' +
    '<p style="margin:0 0 6px 0;"><img src="' + base + '/Assets/email-icons/lights-line-v2.png" width="32" height="32" style="display:block;margin:0 auto;border:none;width:32px;height:32px;" alt="Luces"/></p>' +
