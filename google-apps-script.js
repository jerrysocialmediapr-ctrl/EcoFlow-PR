...
function buildEcoFlowEmail(nombre, productKey) {
  ...
  return '<!DOCTYPE html>' +
    ...
    '<p style="margin:0 0 6px 0;"><img src="https://cdn.jsdelivr.net/gh/jerrysocialmediapr-ctrl/EcoFlow-PR@main/Assets/email-icons/fan.png" width="32" height="32" style="display:block;margin:0 auto;border:none;width:32px;height:32px;" alt="Abanico"/></p>' +
    ...
    '<td width="2%"></td>' +
    '<td width="23%" align="center" bgcolor="#f4f9f6" style="border-radius:10px;padding:14px 6px;">' +
    '<p style="margin:0 0 6px 0;"><img src="https://cdn.jsdelivr.net/gh/jerrysocialmediapr-ctrl/EcoFlow-PR@main/Assets/email-icons/fridge.png" width="32" height="32" style="display:block;margin:0 auto;border:none;width:32px;height:32px;" alt="Nevera"/></p>' +
    ...
    '<td width="2%"></td>' +
    '<td width="23%" align="center" bgcolor="#f4f9f6" style="border-radius:10px;padding:14px 6px;">' +
    '<p style="margin:0 0 6px 0;"><img src="https://cdn.jsdelivr.net/gh/jerrysocialmediapr-ctrl/EcoFlow-PR@main/Assets/email-icons/television.png" width="32" height="32" style="display:block;margin:0 auto;border:none;width:32px;height:32px;" alt="Televisor"/></p>' +
    ...
    '<td width="2%"></td>' +
    '<td width="23%" align="center" bgcolor="#f4f9f6" style="border-radius:10px;padding:14px 6px;">' +
    '<p style="margin:0 0 6px 0;"><img src="https://cdn.jsdelivr.net/gh/jerrysocialmediapr-ctrl/EcoFlow-PR@main/Assets/email-icons/lights.png" width="32" height="32" style="display:block;margin:0 auto;border:none;width:32px;height:32px;" alt="Luces"/></p>' +
